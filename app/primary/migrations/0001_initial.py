    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('lots_number', models.IntegerField(default=0, verbose_name='Кол-во лотов')),
                ('district', models.CharField(blank=True, default='', max_length=100, verbose_name='Округ')),
                ('subway', models.CharField(blank=True, default='', max_length=100, verbose_name='Метро')),
                ('lots_numodels_baseer', models.CharField(blank=True, default='по запросу', max_length=100, verbose_name='Кол-во лотов')),
